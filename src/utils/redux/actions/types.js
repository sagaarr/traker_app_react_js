...
export const GET_LOCATIONS_REQ = "GET_LOCATIONS_REQ";
export const GET_LOCATIONS_SUCCESS = "GET_LOCATIONS_SUCCESS";
export const GET_LOCATIONS_FAIL = "GET_LOCATIONS_FAIL";

export const GET_USERS_AMBULANCE_REQ = "GET_USERS_AMBULANCE_REQ";
export const GET_USERS_AMBULANCE_SUCCESS = "GET_USERS_AMBULANCE_SUCCESS";
export const GET_USERS_AMBULANCE_FAIL = "GET_USERS_AMBULANCE_FAIL";
